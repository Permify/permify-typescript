...
export function RuleDefinitionToJSON(json: any): RuleDefinition {
    return RuleDefinitionToJSONTyped(json, false);
}

export function RuleDefinitionToJSONTyped(value?: RuleDefinition | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
