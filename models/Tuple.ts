...
export function TupleToJSON(json: any): Tuple {
    return TupleToJSONTyped(json, false);
}

export function TupleToJSONTyped(value?: Tuple | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
