...
export function V1alpha1TypeToJSON(json: any): V1alpha1Type {
    return V1alpha1TypeToJSONTyped(json, false);
}

export function V1alpha1TypeToJSONTyped(value?: V1alpha1Type | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
