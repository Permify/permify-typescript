...
export function V1alpha1ReferenceToJSON(json: any): V1alpha1Reference {
    return V1alpha1ReferenceToJSONTyped(json, false);
}

export function V1alpha1ReferenceToJSONTyped(value?: V1alpha1Reference | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
