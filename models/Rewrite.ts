...
export function RewriteToJSON(json: any): Rewrite {
    return RewriteToJSONTyped(json, false);
}

export function RewriteToJSONTyped(value?: Rewrite | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
