...
export function TenantListResponseToJSON(json: any): TenantListResponse {
    return TenantListResponseToJSONTyped(json, false);
}

export function TenantListResponseToJSONTyped(value?: TenantListResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
