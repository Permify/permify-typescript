...
import {
    ...
    DataChangeOperationToJSONTyped,
...
export function DataChangeToJSON(json: any): DataChange {
    return DataChangeToJSONTyped(json, false);
}

export function DataChangeToJSONTyped(value?: DataChange | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
