...
import {
    ...
    PermissionDefinitionToJSONTyped,
...
import {
    ...
    EntityDefinitionReferenceToJSONTyped,
...
import {
    ...
    AttributeDefinitionToJSONTyped,
...
export function EntityDefinitionToJSON(json: any): EntityDefinition {
    return EntityDefinitionToJSONTyped(json, false);
}

export function EntityDefinitionToJSONTyped(value?: EntityDefinition | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
