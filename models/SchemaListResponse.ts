...
export function SchemaListResponseToJSON(json: any): SchemaListResponse {
    return SchemaListResponseToJSONTyped(json, false);
}

export function SchemaListResponseToJSONTyped(value?: SchemaListResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
