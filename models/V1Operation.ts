...
export function V1OperationToJSON(json: any): V1Operation {
    return V1OperationToJSONTyped(json, false);
}

export function V1OperationToJSONTyped(value?: V1Operation | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
