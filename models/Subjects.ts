...
export function SubjectsToJSON(json: any): Subjects {
    return SubjectsToJSONTyped(json, false);
}

export function SubjectsToJSONTyped(value?: Subjects | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
