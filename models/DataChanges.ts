...
export function DataChangesToJSON(json: any): DataChanges {
    return DataChangesToJSONTyped(json, false);
}

export function DataChangesToJSONTyped(value?: DataChanges | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
