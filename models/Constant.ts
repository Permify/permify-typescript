...
export function ConstantToJSON(json: any): Constant {
    return ConstantToJSONTyped(json, false);
}

export function ConstantToJSONTyped(value?: Constant | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'timestampValue': value['timestampValue'] == null ? value['timestampValue'] : value['timestampValue'].toISOString(),
    };
}
