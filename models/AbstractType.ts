...
export function AbstractTypeToJSON(json: any): AbstractType {
    return AbstractTypeToJSONTyped(json, false);
}

export function AbstractTypeToJSONTyped(value?: AbstractType | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
