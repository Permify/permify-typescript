...
export function TenantListRequestToJSON(json: any): TenantListRequest {
    return TenantListRequestToJSONTyped(json, false);
}

export function TenantListRequestToJSONTyped(value?: TenantListRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
