...
export function RelationshipDeleteResponseToJSON(json: any): RelationshipDeleteResponse {
    return RelationshipDeleteResponseToJSONTyped(json, false);
}

export function RelationshipDeleteResponseToJSONTyped(value?: RelationshipDeleteResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
