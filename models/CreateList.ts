...
export function CreateListToJSON(json: any): CreateList {
    return CreateListToJSONTyped(json, false);
}

export function CreateListToJSONTyped(value?: CreateList | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
