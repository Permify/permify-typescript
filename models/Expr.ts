...
export function ExprToJSON(json: any): Expr {
    return ExprToJSONTyped(json, false);
}

export function ExprToJSONTyped(value?: Expr | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
