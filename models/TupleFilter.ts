...
export function TupleFilterToJSON(json: any): TupleFilter {
    return TupleFilterToJSONTyped(json, false);
}

export function TupleFilterToJSONTyped(value?: TupleFilter | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
