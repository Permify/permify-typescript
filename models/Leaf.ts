...
export function LeafToJSON(json: any): Leaf {
    return LeafToJSONTyped(json, false);
}

export function LeafToJSONTyped(value?: Leaf | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
