...
export function PermissionLookupEntityRequestMetadataToJSON(json: any): PermissionLookupEntityRequestMetadata {
    return PermissionLookupEntityRequestMetadataToJSONTyped(json, false);
}

export function PermissionLookupEntityRequestMetadataToJSONTyped(value?: PermissionLookupEntityRequestMetadata | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
