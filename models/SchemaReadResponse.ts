...
export function SchemaReadResponseToJSON(json: any): SchemaReadResponse {
    return SchemaReadResponseToJSONTyped(json, false);
}

export function SchemaReadResponseToJSONTyped(value?: SchemaReadResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
