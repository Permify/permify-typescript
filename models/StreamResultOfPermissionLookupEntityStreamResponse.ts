...
import {
    ...
    PermissionLookupEntityStreamResponseToJSONTyped,
...
export function StreamResultOfPermissionLookupEntityStreamResponseToJSON(json: any): StreamResultOfPermissionLookupEntityStreamResponse {
    return StreamResultOfPermissionLookupEntityStreamResponseToJSONTyped(json, false);
}

export function StreamResultOfPermissionLookupEntityStreamResponseToJSONTyped(value?: StreamResultOfPermissionLookupEntityStreamResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
