...
export function DataBundleToJSON(json: any): DataBundle {
    return DataBundleToJSONTyped(json, false);
}

export function DataBundleToJSONTyped(value?: DataBundle | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
