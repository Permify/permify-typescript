...
export function PermissionCheckRequestMetadataToJSON(json: any): PermissionCheckRequestMetadata {
    return PermissionCheckRequestMetadataToJSONTyped(json, false);
}

export function PermissionCheckRequestMetadataToJSONTyped(value?: PermissionCheckRequestMetadata | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
