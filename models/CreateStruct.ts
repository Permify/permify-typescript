...
export function CreateStructToJSON(json: any): CreateStruct {
    return CreateStructToJSONTyped(json, false);
}

export function CreateStructToJSONTyped(value?: CreateStruct | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
