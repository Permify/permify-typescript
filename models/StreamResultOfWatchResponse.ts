...
export function StreamResultOfWatchResponseToJSON(json: any): StreamResultOfWatchResponse {
    return StreamResultOfWatchResponseToJSONTyped(json, false);
}

export function StreamResultOfWatchResponseToJSONTyped(value?: StreamResultOfWatchResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
