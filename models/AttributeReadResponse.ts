...
export function AttributeReadResponseToJSON(json: any): AttributeReadResponse {
    return AttributeReadResponseToJSONTyped(json, false);
}

export function AttributeReadResponseToJSONTyped(value?: AttributeReadResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
