...
export function ComputedUserSetToJSON(json: any): ComputedUserSet {
    return ComputedUserSetToJSONTyped(json, false);
}

export function ComputedUserSetToJSONTyped(value?: ComputedUserSet | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
