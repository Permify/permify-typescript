...
export function SchemaPartialWriteRequestMetadataToJSON(json: any): SchemaPartialWriteRequestMetadata {
    return SchemaPartialWriteRequestMetadataToJSONTyped(json, false);
}

export function SchemaPartialWriteRequestMetadataToJSONTyped(value?: SchemaPartialWriteRequestMetadata | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
