...
export function PermissionLookupSubjectRequestMetadataToJSON(json: any): PermissionLookupSubjectRequestMetadata {
    return PermissionLookupSubjectRequestMetadataToJSONTyped(json, false);
}

export function PermissionLookupSubjectRequestMetadataToJSONTyped(value?: PermissionLookupSubjectRequestMetadata | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
