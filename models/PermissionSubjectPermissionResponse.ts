...
export function PermissionSubjectPermissionResponseToJSON(json: any): PermissionSubjectPermissionResponse {
    return PermissionSubjectPermissionResponseToJSONTyped(json, false);
}

export function PermissionSubjectPermissionResponseToJSONTyped(value?: PermissionSubjectPermissionResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
