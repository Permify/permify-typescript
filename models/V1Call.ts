...
export function V1CallToJSON(json: any): V1Call {
    return V1CallToJSONTyped(json, false);
}

export function V1CallToJSONTyped(value?: V1Call | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
