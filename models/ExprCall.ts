...
export function ExprCallToJSON(json: any): ExprCall {
    return ExprCallToJSONTyped(json, false);
}

export function ExprCallToJSONTyped(value?: ExprCall | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
