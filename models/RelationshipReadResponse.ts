...
export function RelationshipReadResponseToJSON(json: any): RelationshipReadResponse {
    return RelationshipReadResponseToJSONTyped(json, false);
}

export function RelationshipReadResponseToJSONTyped(value?: RelationshipReadResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
