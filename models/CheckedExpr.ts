...
export function CheckedExprToJSON(json: any): CheckedExpr {
    return CheckedExprToJSONTyped(json, false);
}

export function CheckedExprToJSONTyped(value?: CheckedExpr | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
