...
export function FunctionTypeToJSON(json: any): FunctionType {
    return FunctionTypeToJSONTyped(json, false);
}

export function FunctionTypeToJSONTyped(value?: FunctionType | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
