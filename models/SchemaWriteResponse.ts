...
export function SchemaWriteResponseToJSON(json: any): SchemaWriteResponse {
    return SchemaWriteResponseToJSONTyped(json, false);
}

export function SchemaWriteResponseToJSONTyped(value?: SchemaWriteResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
