...
export function ExpandLeafToJSON(json: any): ExpandLeaf {
    return ExpandLeafToJSONTyped(json, false);
}

export function ExpandLeafToJSONTyped(value?: ExpandLeaf | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
