...
export function SelectToJSON(json: any): Select {
    return SelectToJSONTyped(json, false);
}

export function SelectToJSONTyped(value?: Select | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
