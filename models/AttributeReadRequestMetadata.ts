...
export function AttributeReadRequestMetadataToJSON(json: any): AttributeReadRequestMetadata {
    return AttributeReadRequestMetadataToJSONTyped(json, false);
}

export function AttributeReadRequestMetadataToJSONTyped(value?: AttributeReadRequestMetadata | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
