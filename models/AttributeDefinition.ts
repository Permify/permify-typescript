...
export function AttributeDefinitionToJSON(json: any): AttributeDefinition {
    return AttributeDefinitionToJSONTyped(json, false);
}

export function AttributeDefinitionToJSONTyped(value?: AttributeDefinition | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
